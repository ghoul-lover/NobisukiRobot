...
import jikanpy
import requests
from NobisukiRobot import dispatcher
...
def kaizoku(update: Update, context: CallbackContext):
    site_search(update, context, "United")


@run_async
def kayo(update: Update, context: CallbackContext):
    site_search(update, context, "pegasus")
...
KAIZOKU_SEARCH_HANDLER = DisableAbleCommandHandler("United", kaizoku)
...
__handlers__ = [
    ...
    USER_HANDLER,
    UPCOMING_HANDLER,
    UNITED_SEARCH_HANDLER,
    PEGASUS_SEARCH_HANDLER,
    AIRING_HANDLER,
]
